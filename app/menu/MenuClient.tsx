...
export default function MenuClient() {
  ...
  const nutritionCells = [
    { k: "Protein", v: `${product.protein}g`, hot: true },
    { k: "Calories", v: product.calories },
    { k: "Carbs", v: `${product.carbs}g` },
    { k: "Fat", v: `${product.fat}g` },
  ];
      ...
      <section className="pt-[72px] pb-12">
        <div className="container-site">
          <div>
            ...
            >
              Every shake starts with whey isolate and whole ingredients. No
              added sugar, no artificial colours, no thickeners. Blended on
              order.
            </p>
          </div>
        </div>
        ...
        <div className="container-site">
          ...
          >
            ...
            <div>
              ...
              <div
                className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-9 py-6"
            ...
            {products.map((p) => (
              ...
              >
                <div className="flex justify-between">
                  ...
                  >
                    <b style={{ fontSize: 22 }}>{p.protein}g</b>
                  </div>
                </div>
